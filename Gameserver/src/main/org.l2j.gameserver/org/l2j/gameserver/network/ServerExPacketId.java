...
public enum ServerExPacketId {
    ...
    EX_LOGIN_SAYHA_GRACE_EFFECT_INFO,
    ...
    EX_RANKING_CHAR_BUFFZONE_NPC_INFO,
    EX_RANKING_CHAR_BUFFZONE_NPC_POSITION,
    EX_BOW_ACTION_TO,
    ...
    EX_PET_SKILL_LIST,
    EX_OPEN_BLESS_OPTION_SCROLL,
    EX_BLESS_OPTION_PUT_ITEM,
    EX_BLESS_OPTION_ENCHANT,
    EX_BLESS_OPTION_CANCEL,
    EX_PVP_RANKING_MY_INFO,
    EX_PVP_RANKING_LIST,
    EX_PLEDGE_V3_INFO,
    EX_PLEDGE_ENEMY_INFO_LIST,
    EX_ITEM_DELETION_INFO,
    EX_PK_PENALTY_LIST,
    EX_PK_PENALTY_LIST_ONLY_LOC,
    EX_SHOW_PET_EXTRACT_SYSTEM,
    EX_RESULT_PET_EXTRACT_SYSTEM,
    EX_HIDE_PET_EXTRACT_SYSTEM,
    EX_RANKING_FESTIVAL_SIDEBAR_INFO,
    EX_RANKING_FESTIVAL_BUY,
    EX_RANKING_FESTIVAL_BONUS,
    EX_RANKING_FESTIVAL_RANKING,
    EX_RANKING_FESTIVAL_MYINFO,
    EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS,
    EX_RANKING_FESTIVAL_REWARD,
    EX_TIMER_CHECK,
    EX_STEADY_BOX_UI_INIT,
    EX_STEADY_ALL_BOX_UPDATE,
    EX_STEADY_ONE_BOX_UPDATE,
    EX_STEADY_BOX_REWARD,
    EX_PET_RANKING_MY_INFO,
    EX_PET_RANKING_LIST,
    EX_COLLECTION_INFO,
    EX_COLLECTION_OPEN_UI,
    EX_COLLECTION_CLOSE_UI,
    EX_COLLECTION_LIST,
    EX_COLLECTION_UPDATE_FAVORITE,
    EX_COLLECTION_FAVORITE_LIST,
    EX_COLLECTION_SUMMARY,
    EX_COLLECTION_REGISTER,
    EX_COLLECTION_COMPLETE,
    EX_COLLECTION_RECEIVE_REWARD,
    EX_COLLECTION_RESET,
    EX_COLLECTION_ACTIVE_EVENT,
    EX_COLLECTION_RESET_REWARD,
    EX_PVPBOOK_SHARE_REVENGE_LIST,
    EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION,
    EX_PVPBOOK_SHARE_REVENGE_NEW_REVENGEINFO,
    EX_PENALTY_ITEM_DROP,
    EX_PENALTY_ITEM_LIST,
    EX_PENALTY_ITEM_RESTORE,
    EX_USER_WATCHER_TARGET_LIST,
    EX_USER_WATCHER_TARGET_STATUS,
    EX_HOMUNCULUS_ACTIVATE_SLOT_RESULT,
    EX_SHOW_HOMUNCULUS_COUPON_UI,
    EX_SUMMON_HOMUNCULUS_COUPON_RESULT,
    EX_PENALTY_ITEM_INFO,
    EX_MAGIC_SKILL_USE_GROUND,
    EX_SUBJUGATION_SIDEBAR,
    EX_SUBJUGATION_LIST,
    EX_SUBJUGATION_RANKING,
    EX_SUBJUGATION_GACHA_UI,
    EX_SUBJUGATION_GACHA,
    EX_USER_VIEW_INFO_PARAMETER,
    EX_PLEDGE_DONATION_INFO,
    EX_PLEDGE_DONATION_REQUEST,
    EX_PLEDGE_CONTRIBUTION_LIST,
    EX_PLEDGE_RANKING_MY_INFO,
    EX_PLEDGE_RANKING_LIST,
    EX_ITEM_RESTORE_LIST,
    EX_ITEM_RESTORE,
    EX_PLEDGE_COIN_INFO,
    EX_DETHRONE_INFO,
    EX_DETHRONE_RANKING_INFO,
    EX_DETHRONE_SERVER_INFO,
    EX_DETHRONE_DISTRICT_OCCUPATION_INFO,
    EX_DETHRONE_DAILY_MISSION_INFO,
    EX_DETHRONE_DAILY_MISSION_GET_REWARD,
    EX_DETHRONE_DAILY_MISSION_COMPLETE,
    EX_DETHRONE_PREV_SEASON_INFO,
    EX_DETHRONE_GET_REWARD,
    EX_DETHRONE_CHECK_NAME,
    EX_DETHRONE_CHANGE_NAME,
    EX_DETHRONE_CONNECT_CASTLE,
    EX_DETHRONE_DISCONNECT_CASTLE,
    EX_DETHRONE_SEASON_INFO,
    EX_SERVERLIMIT_ITEM_ANNOUNCE,
    EX_CHANGE_NICKNAME_COLOR_ICON,
    EX_WORLDCASTLEWAR_HOST_CASTLE_SIEGE_HUD_INFO,
    EX_WORLDCASTLEWAR_CASTLE_INFO,
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_INFO,
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_HUD_INFO,
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_ATTACKER_LIST,
    EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_LIST,
    EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_JOIN,
    EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_OCCUPY_INFO,
    EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_INFO,
    EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_USER,
    EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_SIEGE_GOLEM_INFO,
    EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_DOOR_INFO,
    EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO,
    EX_PRIVATE_STORE_SEARCH_ITEM,
    EX_PRIVATE_STORE_SEARCH_HISTORY,
    EX_PRIVATE_STORE_SEARCH_STATISTICS,
    EX_WORLDCASTLEWAR_HOST_CASTLE_SIEGE_RANKING_INFO,
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_RANKING_INFO,
    EX_NEW_HENNA_LIST,
    EX_NEW_HENNA_EQUIP,
    EX_NEW_HENNA_UNEQUIP,
    EX_NEW_HENNA_POTEN_SELECT,
    EX_NEW_HENNA_POTEN_ENCHANT,
    EX_NEW_HENNA_COMPOSE,
    EX_REQUEST_INVITE_PARTY,
    EX_INIT_GLOBAL_EVENT_UI,
    EX_SHOW_GLOBAL_EVENT_UI,
    EX_L2PASS_SIMPLE_INFO,
    EX_L2PASS_INFO,
    EX_SAYHAS_SUPPORT_INFO,
    ;
