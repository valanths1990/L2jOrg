...
public enum ExIncomingPackets implements PacketFactory {
    ...
    // 338
    EX_DETHRONE_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_RANKING_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_SERVER_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_DISTRICT_OCCUPATION_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_DAILY_MISSION_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_DAILY_MISSION_GET_REWARD(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_PREV_SEASON_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_GET_REWARD(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_ENTER(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_LEAVE(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_CHECK_NAME(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_CHANGE_NAME(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_CONNECT_CASTLE(null, ConnectionState.IN_GAME_STATES),
    EX_DETHRONE_DISCONNECT_CASTLE(null, ConnectionState.IN_GAME_STATES),
    EX_CHANGE_NICKNAME_COLOR_ICON(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_MOVE_TO_HOST(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_RETURN_TO_ORIGIN_PEER(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_CASTLE_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_JOIN(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_ATTACKER_LIST(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_RECRUIT_INFO_SET(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_LIST(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_JOIN(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_TELEPORT(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_OBSERVER_START(null, ConnectionState.IN_GAME_STATES),
    EX_PRIVATE_STORE_SEARCH_LIST(null, ConnectionState.IN_GAME_STATES),
    EX_PRIVATE_STORE_SEARCH_STATISTICS(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_HOST_CASTLE_SIEGE_RANKING_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_CASTLE_SIEGE_RANKING_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_NEW_HENNA_LIST(null, ConnectionState.IN_GAME_STATES),
    EX_NEW_HENNA_EQUIP(null, ConnectionState.IN_GAME_STATES),
    EX_NEW_HENNA_UNEQUIP(null, ConnectionState.IN_GAME_STATES),
    EX_NEW_HENNA_POTEN_SELECT(null, ConnectionState.IN_GAME_STATES),
    EX_NEW_HENNA_POTEN_ENCHANT(null, ConnectionState.IN_GAME_STATES),
    EX_NEW_HENNA_COMPOSE(null, ConnectionState.IN_GAME_STATES),
    EX_REQUEST_INVITE_PARTY(null, ConnectionState.IN_GAME_STATES),
    EX_ITEM_USABLE_LIST(null, ConnectionState.IN_GAME_STATES),
    EX_PACKETREADCOUNTPERSECOND(null, ConnectionState.IN_GAME_STATES),
    EX_SELECT_GLOBAL_EVENT_UI(null, ConnectionState.IN_GAME_STATES),
    EX_L2PASS_INFO(null, ConnectionState.IN_GAME_STATES),
    EX_L2PASS_REQUEST_REWARD(null, ConnectionState.IN_GAME_STATES),
    EX_L2PASS_REQUEST_REWARD_ALL(null, ConnectionState.IN_GAME_STATES),
    EX_L2PASS_BUY_PREMIUM(null, ConnectionState.IN_GAME_STATES),
    EX_SAYHAS_SUPPORT_TOGGLE(null, ConnectionState.IN_GAME_STATES),
    ;
